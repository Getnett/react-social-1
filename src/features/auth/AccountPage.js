		...
		<Segment>
				...
				<>
					...
					<Formik
						...
						validationSchema={Yup.object({
							...
							confirmPassword: Yup.string().oneOf([Yup.ref('newPassword'), null], 'Passwords dont match'),
						})}
			...
			{currentUser.providerId === 'google.com' && (
				<>
					...
					<Button icon="google" color="google plus" as={Link} to="https://accounts.google.com" content="Go to Google" />
				</>
			)}
		</Segment>
	);
